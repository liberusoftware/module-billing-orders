...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-billing-orders?sort=semver)](https://github.com/liberusoftware/module-billing-orders/releases/latest) [![Tests](https://github.com/liberusoftware/module-billing-orders/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-billing-orders/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-billing-orders
```
...
<a href="https://github.com/liberusoftware/module-billing-orders/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-billing-orders" alt="Contributors to liberusoftware/module-billing-orders">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-billing-orders/graphs/contributors).
